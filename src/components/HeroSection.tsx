...
import { ArrowDown, ChevronRight, Github, Star } from 'lucide-react';
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Star 
          className="w-6 h-6 text-zinc-700/20 group-hover:text-sky-400 group-hover:scale-125 transition-all duration-500 group-hover:drop-shadow-[0_0_12px_rgba(56,189,248,0.8)]" 
          fill="currentColor"
        />
        {/* Subtle shooting star tail effect on hover */}
        <div className="absolute top-1/2 left-1/2 w-12 h-px bg-gradient-to-r from-sky-400 to-transparent -translate-y-1/2 translate-x-1 opacity-0 group-hover:opacity-100 transition-opacity duration-500 origin-left -rotate-45 pointer-events-none" />
      </div>
